"""Build report-style figures from Four-Rooms postprocessed CSV tables."""
...
def parse_args() -> argparse.Namespace:
    """Define the CLI for rebuilding Four-Rooms report figures."""
    parser = argparse.ArgumentParser(
        description="Build report-style figures from Four-Rooms final_results CSVs."
    )
...
def make_all_figures(results_dir: Path, output_dir: Path) -> None:
    """Build every Four-Rooms report figure."""
...
def main() -> None:
    """Entry point for rebuilding Four-Rooms figures."""
    args = parse_args()
    for legacy_path in [
